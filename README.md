...
##### :balloon: サイトのキャラクターに勝男という、昔は弱々しかった男の子を設定しました。チケットの購入を通じての出会いがきっかけとなり、現在の筋肉マンの勝男に成長したというイメージをサイト上で描きました。そして、使ってもらう方にも勝男と同じような成長体験をして頂けることを願い実装を進めました。
...
##### :three:購入価格の自動調整機能を実装し、購入者の学生区分によって価格が自動て調整されるように実装しました。
